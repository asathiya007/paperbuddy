    ...
    def __init__(self, arxiv_paper_ids, load_stores=False):
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            ('system', '''
             ...
             Your response should only include the answer to the question with
             any details that are necessary for the user to understand the
             answer. Do not include unnecessary information in your answer.
             '''),
            ('user', '{input}')
        ])
